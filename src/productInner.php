<?php
	...
	// 		WHERE i.product_show = '0' AND p.product_no=:id"; //準備好sql指令
	
		// $sql = "SELECT p.product_no, p.name, p.description, p.specification, p.price, d.des_name, d.des_text, 'd.des_img_path', i.image_path

		// $sql = "SELECT p.product_no, p.des_no, p.name, p.description, p.specification, p.price, d.des_name, d.des_text, d.des_publish, 'd.des_img_path', i.product_show, i.image_path, r.promotions_no, r.promotions_price, m.promotions_no, m.promotions_name, m.promotions_startDate, m.promotions_endDate, m.promotions_text, f.member_no

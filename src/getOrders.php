...
try{
	...
	$limit = $countsRows['num']*4;
    $sql = "select * from product_order po join orderdetail o on (po.order_no = o.order_no) join product p on(o.product_no = p.product_no) join product_image pm on (p.product_no = pm.product_no) ORDER BY order_datetime DESC LIMIT $limit";
